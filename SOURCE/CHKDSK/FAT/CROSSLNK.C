...
#include <stdio.h>
#include <stdlib.h>
#include "..\kitten.h" /* Header fr NLS */
                                  ...
                                  struct DirectoryPosition* pos)
{
   ...
   {
      case FALSE:
           printf(kittengets(7, 1, "Insufficient disk space to undouble cross linked clusters\n"));
           return TRUE;
   ...
   {              
       ...
       switch (ExtendFileChain(handle, target, &newcluster))
       {
         case FAIL:
              return FALSE;
         case FALSE:
              /* Auch ReportGeneralRemark kriegt den bersetzten String */
              ReportGeneralRemark(kittengets(7, 1, "Insufficient disk space to undouble cross linked clusters\n"));
              return TRUE;
       }
                                ...
                                void** structure)
{
   ...
   while (ref)
   {
      ...
      {  
         printf(kittengets(7, 2, "%s is cross linked\n"), filename);     
#if 0              
         /* Dieser inaktive Block wird nicht bersetzt */
         if (pipe->listcount > 2)
         {
            printf("%s, ", filename);
         }
